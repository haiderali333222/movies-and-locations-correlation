...
# Sort movies by impact
top_10_movies = movie_impact_df.sort_values(by='impact', ascending=False).head(10)

print("Top 10 movies which had impact on locations once they got popular:")
print(top_10_movies[['film_id', 'name_y', 'impact', 'pre_movie_pop', 'post_movie_pop']])

# Output the top 10 movies with impact on locations
top_10_movies[['film_id', 'name_y', 'impact', 'pre_movie_pop', 'post_movie_pop']].to_csv('top_10_movies_impact.csv', index=False)
